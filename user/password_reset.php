...
<head>
    ...
    <title>Forgot Password | Usman Clothing Services Online Shopping</title>
...
<body>
    ...
    <div class="container_wrapper_sign_in_sign_up">
        ...
        <div class="card" id="user_log_box">
            ...
            <form id="reset_pwd_user">
                <div class="container_iden">
                    <div class="center">
                        <h2>Recover your password</h2>
                        <p class="subheading" id="subH">You can request a password reset below. We will send a security code to the email address, please make sure it is correct.</p>
                    </div>
                    ...
                    <div class="flelds">
                        ...
                        <div id="email_input">
                            ...
                            <div class="div_edit">
                                <a href="loginUser.php?redirect=<?php echo htmlspecialchars($_GET['redirect'] ?? 'index.php');   ?>"> edit </a>
                            </div>
                        </div>
                    ...
                    <div class="controls">
                        <div class="btn_contrl">
                            <button id="Continue" type="button" class="cont_btn disabled">Request Password reset</button>
                        </div>
        ...
        <div class="card" id="otp_verify">
            ...
            <form id="user_verify_otp">
                <div class="container_iden">
                    ...
                    <div class="controls">
                        <div class="btn_contrl">
                            <button id="verify_opt" type="button" class="cont_btn">Submit</button>
                        </div>
        ...
        <div class="card" id="reset_pwd_c">
            ...
            <form id="ch_pwd_user">
                <div class="container_iden">
                    <div class="center">
                        <h2 id="reset_pwd">Reset your password</h2>
                        <p class="subheading" id="subH">Insert your new password</p>
                    </div>

                    <div class="flelds">


                        <div id="pwd_input_reset">
                            <div class="identifiyer_d">
                                <input type="password" placeholder="Enter New password " name="newPassword" id="password" class="input_user" required>
                    ...
                    <div class="controls">
                        <div class="btn_contrl">
                            <button id="reset_pwd_btn" type="button" class="cont_btn disabled" disabled>Change Password</button>
                        </div>
    ...
    <script src="./javascript/reset_pwd.js"></script>
